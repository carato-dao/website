...
<div class="bmt-sidebar main-menu">
	<div class="bmt-sidebar-header">
		<div class="bmt-side-logo">
			<img src="/bmt/layout/images/logo_w.png" width="100%">
		</div>	
	</div>
	<div class="bmt-wrap-menu nano">
		<div class="nano-content">
			<a href="<?php echo $subdomain; ?>/bmt/" class="bmt-menu-button <?php if($route=='index'){echo 'bmt-menu-button-active';} ?>">
				<?php echo $bmt_locales['dashboard']['menu']; ?></a>
			<a href="<?php echo $subdomain; ?>/bmt/pages" class="bmt-menu-button <?php if($route=='pages'){echo 'bmt-menu-button-active';} ?>">
				<?php echo $bmt_locales['pages']['menu']; ?></a>
			<a href="<?php echo $subdomain; ?>/bmt/menu" class="bmt-menu-button <?php if($route=='menu'){echo 'bmt-menu-button-active';} ?>">
				<?php echo $bmt_locales['menu']['menu']; ?></a></a>
			<a href="javascript:openSubmenu('datatypes')" class="bmt-menu-button <?php if($route=='customdata'){echo 'bmt-menu-button-active';} ?>">
				<?php echo $bmt_locales['custom_datatypes']['menu']; ?></a></a>
			...
			<a href="<?php echo $subdomain; ?>/bmt/translations" class="bmt-menu-button <?php if($route=='translations'){echo 'bmt-menu-button-active';} ?>">
				<?php echo $bmt_locales['translations']['menu']; ?></a></a>
			
			<a href="javascript:openSubmenu('utility')" class="bmt-menu-button 
				<?php if($route=='filemanager' || $route=='database'){echo 'bmt-menu-button-active';} ?>">
			...
			<a href="javascript:openSubmenu('settings')" class="bmt-menu-button 
				<?php if($route=='admins' || $route=='datatypes' || $route=='configs' || $route=='crypted_configs'){echo 'bmt-menu-button-active';} ?>">
			...
			<div class="bmt-wrap-submenu" id="settings">
				...
				<?php if(getUserLevel($user['level'])==5){ ?>
					<a href="<?php echo $subdomain; ?>/bmt/configs" class="bmt-menu-button">
						<?php echo $bmt_locales['configs']['menu']; ?>
					</a>
					<a href="<?php echo $subdomain; ?>/bmt/manage-datatypes" class="bmt-menu-button">
						<?php echo $bmt_locales['manage_datatypes']['menu']; ?>
					</a>
				<?php } ?>
			</div>
			<a href="<?php echo $subdomain; ?>/bmt/info" class="bmt-menu-button <?php if($route=='info'){echo 'bmt-menu-button-active';} ?>">
